                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="menu_list" id="" class="form-control">
                                <option {{$service->menu_list === 'false' ? 'selected' : null}}  value="false">Not required</option>
                                <option {{$service->menu_list === 'true' ? 'selected' : null}}  value="true">link to menu</option>
                            </select>
                            <span class="text-danger">
                                @error('menu_list')
                                    {{ $message }}
